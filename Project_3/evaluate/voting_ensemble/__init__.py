...
# Define a simple replacement for the voting ensemble classifier
class VotingEnsembleClassifier(VotingClassifier):
    """A simplified VotingEnsembleClassifier for evaluation purposes only."""
    def __init__(self, estimators=None, voting='soft'):
        super().__init__(estimators=estimators or [], voting=voting)
